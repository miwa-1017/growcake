...
ActiveRecord::Schema.define(version: 2025_12_13_070344) do
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.integer "cake_type", default: 0
    t.boolean "growth_finished"
    t.integer "default"
